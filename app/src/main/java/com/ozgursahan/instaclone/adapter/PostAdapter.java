package com.ozgursahan.instaclone.adapter;
...
import com.ozgursahan.instaclone.databinding.RecyclerRowBinding;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostHolder> {
    ...
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        ...
        holder.recyclerRowBinding.recyclerViewDate.setText(postArrayList.get(position).date);
